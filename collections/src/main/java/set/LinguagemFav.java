...
public class LinguagemFav {
    public static void main(String[] args) {
        ...
        Set<LinguagemFavorita> minhasLinguagensFavoritas4 = new TreeSet<LinguagemFavorita>(new ComparatorAnoCriacaoNome());
        ...
        for (LinguagemFavorita liguagem: minhasLinguagensFavoritas5)
