...
public class ExercicioEstados {
    public static void main(String[] args) {
        ...
        System.out.println("Exiba todos os e suas populações na ordem em que foram informados: ");
        ...
        System.out.println("Exiba a soma da populção desses estados: " + soma);
        /*        int soma2 = 0;
...
*/
        ...
        System.out.println("Exiba a média da população desde dicionário de estados: " + (soma/populacaoEstadosNE.size()));
